...
function ChartContainerComponent() {
  ...
  return (
    <>
            <ChartContainer config={chartConfig} className=' max-w-[100%] h-[180px]  max-h-[620px] mx-auto  rounded-md '>
                        <BarChart accessibilityLayer data={chartData}>
                          ...
                          />
                                  <ChartLegend className='text-blue-300/60 group-hover:text-blue-300 transition-all h-full' content={<ChartLegendContent />} />
